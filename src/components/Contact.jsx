                                    ...
                                    <div class="col-xl-12">
                                        <div class="hero-cap">
                                            ...
                                            <nav aria-label="breadcrumb ">
                                                ...
                                                <li class="breadcrumb-item"><Link to="/contact">Contact</Link></li> 
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email"></input>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
